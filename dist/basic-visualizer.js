	...
	*/
	...
	function StateMachineView({
	  ...
	  const steps = Object.keys(definition.states).map(key => {
	    ...
	    }, key), mode && mode.effects && /*#__PURE__*/React.createElement("small", null, mode.effects.join(", ")), /*#__PURE__*/React.createElement("div", {
	      style: eventsStyle
	    }, events));
	  });
	  return /*#__PURE__*/React.createElement("div", {
	...
	if (!customElements.get('basic-visualizer')) {
	  customElements.define('basic-visualizer', class extends HTMLElement {
	    ...
	    connectedCallback() {
	      ...
	      const dispatch = detail => this.dispatchEvent(new CustomEvent('dispatch', {
	        detail
	      }));
	      const container = document.createElement('div');
	      this.shadowRoot.appendChild(container);
	      const component = /*#__PURE__*/React.createElement(StateMachineView, {
	        definition,
	        value,
	        dispatch
	      });
