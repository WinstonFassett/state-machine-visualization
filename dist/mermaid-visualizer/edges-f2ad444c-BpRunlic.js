import { l as log$1, g as getConfig, r as evaluate, i as sanitizeText$2, aQ as decodeEntities, d as select, F as curveBasis, A as utils } from './index-mermaid-visualizer.js';
import { a as createText } from './createText-62fc7601-ySWu7fSk.js';
import { l as line } from './line-DAtgJdz3.js';
...
const labelHelper = async (parent, node, _classes, isNode) => {
  ...
  if (node.labelType === "markdown") {
    ...
    text = textNode.appendChild(createLabel$1(sanitizeText$2(decodeEntities(labelText), getConfig()), node.labelStyle, false, isNode));
  }
...
const getClassesFromNode = (node, otherClasses) => {
  return `${"node default"}${formatClass(node.classes)} ${formatClass(node.class)}`;
};
...
export { insertNode as a, insertEdgeLabel as b, insertEdge as c, positionEdgeLabel as d, intersectRect$1 as e, createLabel$1 as f, clear$1 as g, clear as h, insertMarkers$1 as i, getLineFunctionsWithOffset as j, labelHelper as l, positionNode as p, setNodeElem as s, updateNodeBounds as u };
