import { l as log$1, aQ as decodeEntities, b5 as dedent } from './index-mermaid-visualizer.js';
...
const createText = (el, text = "", {
  ...
  if (useHtmlLabels) {
    ...
    const node = {
      isNode,
      label: decodeEntities(htmlText).replace(/fa[blrs]?:fa-[\w-]+/g, s => `<i class='${s.replace(":", " ")}'></i>`),
