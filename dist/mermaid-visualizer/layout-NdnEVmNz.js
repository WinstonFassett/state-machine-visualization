import { a7 as isObjectLike, a8 as baseGetTag, a9 as isArray, aa as Symbol, ab as isObject, ac as arrayLikeKeys, ad as baseKeys, ae as isArrayLike, af as memoize, ag as isArguments, ah as setToString, ai as overRest, aj as copyObject, ak as keysIn, al as getPrototype, am as cloneArrayBuffer, an as cloneTypedArray, ao as getTag, ap as baseUnary, aq as nodeUtil, ar as copyArray, as as isBuffer, at as cloneBuffer, au as initCloneObject, av as Stack, aw as assignValue, ax as MapCache, ay as eq, az as Uint8Array, aA as isTypedArray, aB as isLength, aC as isIndex, aD as identity, aE as baseFor, aF as baseRest, aG as isIterateeCall, aH as baseAssignValue, aI as Set, aJ as isArrayLikeObject, aK as constant, y as isFunction, aL as isEmpty, aM as merge } from './index-mermaid-visualizer.js';
...
var defaults = baseRest(function (object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined || eq(value, objectProto$1[key]) && !hasOwnProperty$1.call(object, key)) {
...
export { Graph as G, baseClone as b, defaults as d, forEach as f, has as h, isUndefined as i, layout as l, map as m, pick as p, range as r, uniqueId as u };
